...
// Test the exam history endpoint with a real token
...
console.log('Testing exam history endpoint...');
console.log('URL: https://echappbackend.onrender.com/api/exams/history');
